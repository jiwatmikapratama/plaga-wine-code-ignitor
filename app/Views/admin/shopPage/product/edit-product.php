                            ...
                            <div class="card">
                                <form action="">
                                    ...
                                    <div class="card-body py-4">
                                        ...
                                        <hr />
                                        <div class="mb-10">
                                            <label for="product-image" class="required form-label">Product Image</label>
                                        ...
                                        <div class="mb-10">
                                            <label for="description" class="required form-label">Product Description</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>
                                        <div class="mb-10">
                                        ...
                                        <div class="mb-10">
                                            <label for="country-detail" class="required form-label">Country Detail</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>
                                        <div class="mb-10">
                                            <label for="occasion-description" class="required form-label">Occasion Description</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>
                                        <div class="mb-10">
                                            <label for="size" class="required form-label">Size (ml)</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>
                                        <div class="mb-10">
                                            <label for="alcohol-percentage" class="required form-label">Alcohol Percentage (%)</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>
                                        <div class="mb-10">
                                            <label for="buy-link" class="required form-label">Buy Link</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>


                                        <div class="col-12 d-flex justify-content-end">
                                            <button type="button" class="btn btn-warning font-weight-bold btn-pill">Edit Product</button>
                                        </div>
                                </form>
                            </div>
                            <!--end::Card body-->

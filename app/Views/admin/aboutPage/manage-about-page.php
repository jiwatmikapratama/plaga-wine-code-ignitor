                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
                                            <span class="menu-link py-3">
                                                <span class="menu-title">Manage About Page</span>
                            ...
                            <div class="card">
                                <form action="">
                                    ...
                                    <div class="card-body py-4">
                                        ...
                                        <div class="mb-10">
                                            <label for="section-title-our-story" class="required form-label">Section Title</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>

                                        <div class="mb-10">
                                            <label for="section-description-our-story" class="required form-label">Section Description</label>
                                            <input type="email" class="form-control form-control-solid" placeholder="" />
                                        </div>


                                        <div class="mb-10">
                                            <label for="section-image-our-story" class="required form-label">Section Images</label>
                                            <input type="file" class="form-control form-control-solid" placeholder="" />
                                        </div>
                                        <!-- end::Our Story -->
                                        <!-- begin::Our Regions -->
                                        <h2>Section Our Regions</h2>
                                        <hr />

                                        <div class="mb-10">
                                            <label for="section-title-our-regions" class="required form-label">Section Title</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>

                                        <div class="mb-10">
                                            <label for="section-description-our-regions" class="required form-label">Section Description</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>


                                        <div class="mb-10">
                                            <label for="section-first-image-our-regions" class="required form-label">Section First Image</label>
                                            <input type="file" class="form-control form-control-solid" placeholder="" />
                                        </div>
                                        <div class="mb-10">
                                            <label for="section-second-image-our-regions" class="required form-label">Section Second Image Image</label>
                                            <input type="file" class="form-control form-control-solid" placeholder="" />
                                        </div>
                                        <!-- end::Our Regions -->
                                        <!-- begin::Elevate Your Everyday -->
                                        <h2>Section Elevate Your Everyday</h2>
                                        <hr />

                                        <div class="mb-10">
                                            <label for="section-title-elevate-your-everyday" class="required form-label">Section Title</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>

                                        <div class="mb-10">
                                            <label for="section-description-elevate-your-everyday" class="required form-label">Section Description</label>
                                            <input type="text" class="form-control form-control-solid" placeholder="" />
                                        </div>

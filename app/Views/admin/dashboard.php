                                            ...
                                            <div class="card-p mt-n20 position-relative">
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                                        ...
                                                        <p class="text-warning fw-bold fs-1">10</p>
                                                    </div>
                                                    <!--end::Col-->
                                                    <!--begin::Col-->
                                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                                        ...
                                                        <p class="text-primary fw-bold fs-1">10</p>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Row-->
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                                        ...
                                                        <a href="#" class="text-danger fw-bold fs-6 mt-2">Item
                                                            Orders</a>
                                                        <p class="text-danger fw-bold fs-1">10</p>
                                                    </div>
                                                    <!--end::Col-->
                                                    <!--begin::Col-->
                                                    <div class="col bg-light-success px-6 py-8 rounded-2">
                                                        ...
                                                        <a href="#" class="text-success fw-bold fs-6 mt-2">Bug
                                                            Reports</a>
                                                        <p class="text-success fw-bold fs-1">10</p>
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <!--end::Row-->
